...
class TritonPythonModel:
    ...
    def __init__(self):
        ...
        self.tokenizer = nemo_nlp.modules.get_tokenizer(tokenizer_name="bert-base-uncased").tokenizer

        self.input_name = ['payload', 'prefix']
    ...
    def execute(self, requests, verbose=True):
      ...
      for request in requests:
        ...
        encoded_input = self.tokenizer(text, padding=True, return_tensors='np')
